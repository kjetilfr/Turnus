                ...
                <div className="space-y-3 mb-3">
                  {check.inputs
                    ...
                    .map(input => {
                      ...
                      // Special handling for nightDefinition input
                      if (input.id === 'nightDefinition') {
                        const nightDef = (inputs.nightDefinition as string) || 'ks'
                        return (
                          <div key={input.id}>
                            <label className="block text-sm font-medium text-gray-700 mb-2">
                              {input.label}:
                            ...
                            <div className="space-y-2">
                              <label className="flex items-center gap-2">
                                <input
                                  type="radio"
                                  name={`nightDef-${check.id}`}
                                  value="ks"
                                  checked={nightDef === 'ks'}
                                  onChange={() => onInputChange('nightDefinition', 'ks')}
                                  className="w-4 h-4 text-indigo-600 border-gray-300 focus:ring-indigo-500"
                                />
                                <span className="text-sm text-gray-700">
                                  <strong>KS (21:00-06:00)</strong> - KS Tariffavtale definisjon
                                </span>
                              </label>
                              <label className="flex items-center gap-2">
                                <input
                                  ...
                                  name={`nightDef-${check.id}`}
                                  value="staten"
                                  checked={nightDef === 'staten'}
                                  onChange={() => onInputChange('nightDefinition', 'staten')}
                                  className="w-4 h-4 text-indigo-600 border-gray-300 focus:ring-indigo-500"
                                />
                                <span className="text-sm text-gray-700">
                                  <strong>STATEN (20:00-06:00)</strong> - Statens tariffavtale definisjon
                                </span>
                              </label>
                              <label className="flex items-center gap-2">
                                <input
                                  ...
                                  name={`nightDef-${check.id}`}
                                  value="oslo"
                                  checked={nightDef === 'oslo'}
                                  onChange={() => onInputChange('nightDefinition', 'oslo')}
                                  className="w-4 h-4 text-indigo-600 border-gray-300 focus:ring-indigo-500"
                                />
                                <span className="text-sm text-gray-700">
                                  <strong>OSLO KOMMUNE (21:00-06:00)</strong> - Oslo Kommune definisjon
                                </span>
                              </label>
                              <label className="flex items-center gap-2">
                                <input
                                  ...
                                  name={`nightDef-${check.id}`}
                                  value="aml"
                                  checked={nightDef === 'aml'}
                                  onChange={() => onInputChange('nightDefinition', 'aml')}
                                  className="w-4 h-4 text-indigo-600 border-gray-300 focus:ring-indigo-500"
                                />
                                <span className="text-sm text-gray-700">
                                  <strong>AML (23:00-06:00)</strong> - Arbeidsmiljøloven § 10-8 definisjon
                                </span>
                              </label>
                            </div>
                          </div>
