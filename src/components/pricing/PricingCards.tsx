...
const tiers: PricingTier[] = [
  ...
  },
  {
    ...
    price: '199',
    period: '/månad',
    description: 'For deg som vil ha AI-hjelp til planlegging',
    tier: 'premium',
    highlighted: true,
    features: [
      'Alt i Pro, pluss:',
      '🤖 Last opp PDF → AI lagar plan',
      '🤖 AI-genererte forbetringar',
      '🤖 Automatisk fylle rotation',
      '🤖 Smartare lovkontroll med forslag',
      '🤖 Personaliserte anbefallingar',
      'Prioritert support',
      '7 dagar gratis prøveperiode',
    ],
    cta: 'Start gratis prøveperiode',
