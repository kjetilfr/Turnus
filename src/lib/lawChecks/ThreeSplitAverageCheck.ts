...
export const threeSplitAverageCheck: LawCheck = {
  ...
  run: ({ rotations, shifts, plan, inputs = {} }) => {
    ...
    const avgNightHours20to6PerWeek = totalNightHours20to6 / plan.duration_weeks
    ...
    // Calculate non-night hours percentage (night = 21:00-06:00 from TIME_PERIODS.NIGHT)
    let totalHours = 0
    let totalNightHours21to6 = 0
    ...
    // 35.5h qualification
    const meetsNightHours35 = avgNightHours20to6PerWeek >= requiredNightHours
